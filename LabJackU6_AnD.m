...
classdef LabJackU6_AnD < handle
    ...
    properties (SetAccess = private)
       ...
       % flag indicating whether the digital input streaming was configured
       % successfully
       digitalInputStreamingConfiguredOK = false;
       ...
       % The sampling duration (analog)
       samplingDurationInSecA;
       
       % The sampling duration (digital)
       samplingDurationInSecD;
    ...
    methods
        % Constructor
        function self = LabJackU6_AnD(varargin)
            % parse inputs
            parser = inputParser;
            parser.addParameter('verbosity',  self.verbosity, @isnumeric);
        ...
        % Method to read the streaming data (analog)
        function [data, errorCode] = getStreamDataA(self)
